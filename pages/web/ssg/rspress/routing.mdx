...
If you want to [customize the routing behavior](https://rspress.dev/guide/basic/conventional-route#custom-behavior), you can use the `route` field in the configuration file
