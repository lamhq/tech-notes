...
<PackageManagerTabs command="install --save-dev jest@^29.7.0 ts-jest@^29.2.5 @jest/globals@^29.7.0" />
...
<PackageManagerTabs command="install --save-dev eslint-plugin-jest@^28.10.0" />
